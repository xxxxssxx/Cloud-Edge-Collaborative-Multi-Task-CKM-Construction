...
def get_default_configs():
  ...
  data.dataset = 'CKM_gain_128'  # 数据集名称  'MNIST' 'CIFAR10' 'CKM_gain_128'
  data.data_dir = "/opt/dpcvol/models/xsx/data/"
  data.image_size = 128       # 测试先用32
  data.random_flip = True  # 是否要随机水平翻转  对gain数据集，应该翻转
  ...
  dp_sampling.task_config = "./configs/dps_configs/inpainting_config.yaml" 
  dp_sampling.checkpoint_num = 40
